...
public class frameSalidas extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtProducto, javax.swing.GroupLayout.DEFAULT_SIZE, 496, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtCantidad, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(btnAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 354, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
	    ...
	    if(unidades <= ProductoDB.findOne(codigoP).getCantidad()){
		SalidaDB.create(new Salida(codigo,unidades,codigoP));
		Producto p = ProductoDB.findOne(codigoP);
		p.vender(unidades);
		ProductoDB.update(p);
		JOptionPane.showMessageDialog(null,"Venta realizada correctamente","GUARDADO",JOptionPane.INFORMATION_MESSAGE);
	    }
	    else{
		JOptionPane.showMessageDialog(null,"No hay suficientes unidades del producto","ERROR",JOptionPane.ERROR_MESSAGE);
	    }
	}
	else{
	...
	List<Salida> salidas = SalidaDB.findAll();
	for(Salida s : salidas){
	    Object[] fila = new Object[5];
	    fila[0] = s.getCodigo();
	    fila[1] = s.getFecha();
	    fila[2] = s.getUnidades();
	    fila[3] = s.getCodigoP();
	    String producto = ProductoDB.findOne(s.getCodigoP()).getNombre();
	    fila[4] = producto;
	    model.addRow(fila);
	}
    }
